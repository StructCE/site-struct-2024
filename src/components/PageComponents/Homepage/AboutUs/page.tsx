...
export default async function Home() {
  ...
  return (
    <>
      <section className="m-0 flex h-[650px] w-full flex-col items-center justify-center gap-9 p-0 font-nunito lg:h-[1000px]">
        {/* Quem Somos */}
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-fundo-3 flex w-[1024px] rounded-2xl">
            {/* Texto e números */}
            <div className="m-8 mr-4 w-[523px]">
              <p className="mb-8">
                ...
                mercado, prezando sempre pela qualidade e satisfação do cliente.
                <br></br>
                <br></br>
              ...
              <div className="flex justify-center gap-8 text-[24px] font-normal">
                <p className="flex w-[120px] flex-col text-center">
                  <span className="text-struct-1 font-oxanium text-[96px] font-semibold leading-[90px]">
                    55
                  </span>{" "}
                  projetos concluídos
                </p>
            ...
            <div className="m-8 ml-4 w-[405px] rounded-lg px-8 shadow-[0_1px_12px_rgb(8,20,38,0.75)]">
              {/* Título */}
              <h4 className="text-struct-2 mb-2 mt-4 flex justify-center font-oxanium text-[24px] font-bold">
                MVV
              </h4>
                ...
                <div>
                  ...
                  <div className="my-2">
                    ...
                    <p className="text-[12px]">
                      ...
                      cliente. Fortalecer a representatividade da EC no ambiente
                      acadêmico e no mercado.
                    </p>
                  </div>
                </div>
                <div className="px-4">
                  <div>
                    ...
                    <div className="flex flex-col gap-2 p-2 font-bold">
                      <p>
                        <span className="text-struct-2 font-oxanium">S</span>
                        inergia
                      </p>
                      <p>
                        <span className="text-struct-2 font-oxanium">T</span>
                        ransparência
                      </p>
                      <p>
                        <span className="text-struct-2 font-oxanium">R</span>
                        espeito
                      </p>
                      <p>
                        <span className="text-struct-2 font-oxanium">U</span>
                        nião
                      </p>
                      <p>
                        <span className="text-struct-2 font-oxanium">C</span>
                        ompromisso
                      </p>
                      <p>
                        <span className="text-struct-2 font-oxanium">T</span>
              ...
              <div className="m-2 flex items-center justify-center">
                <Link
                  href="/membros"
                  className="text-struct-3 border-struct-3 border-b-2 py-1 font-oxanium text-[24px] font-semibold leading-[20px]"
                >
