        ...
        <div className="absolute top-[250px] w-[280px] sm:w-[600px] lg:w-[750px]">
          ...
          <StacksContainer>
            <div className="flex items-center gap-1 sm:gap-2">
              <FaDocker className="h-[20px] w-[20px] text-struct-7 transition delay-75 ease-in-out hover:text-struct-1 sm:h-[36px] sm:w-[36px] lg:h-[46px] lg:w-[46px]" />
              <span className="font-oxanium text-[11px] sm:text-[16px] lg:text-[18px]">
                Docker
              </span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2">
              <FaReact className="h-[20px] w-[20px] text-struct-7 transition delay-75 ease-in-out hover:text-struct-1 sm:h-[36px] sm:w-[36px] lg:h-[46px] lg:w-[46px]" />
              <span className="font-oxanium text-[11px] sm:text-[16px] lg:text-[18px]">
                React
              </span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2">
              <SiTailwindcss className="h-[20px] w-[20px] text-struct-7 transition delay-75 ease-in-out hover:text-struct-1 sm:h-[36px] sm:w-[36px] lg:h-[46px] lg:w-[46px]" />
              <span className="font-oxanium text-[11px] sm:text-[16px] lg:text-[18px]">
                Tailwind
              </span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2">
              <SiPrisma className="h-[20px] w-[20px] text-struct-7 transition delay-75 ease-in-out hover:text-struct-1 sm:h-[36px] sm:w-[36px] lg:h-[46px] lg:w-[46px]" />
              <span className="font-oxanium text-[11px] sm:text-[16px] lg:text-[18px]">
                Prisma
              </span>
            </div>
