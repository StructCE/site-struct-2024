    ...
    <>
      ...
      <div className="m-3 mr-4 w-[256px] sm:m-8 sm:w-[523px]">
        ...
        <p className="mb-3 text-[8px] sm:mb-8 sm:text-base">
          ...
          Universidade de Brasília. Desde 2014, buscamos proporcionar soluções
          com as tecnologias mais atualizadas no mercado, prezando sempre pela
          qualidade e satisfação do cliente.
          <br></br>
          <br></br>
          Somos uma empresa criada, gerida e mantida por alunos universitários,
          com o objetivo de ter um ambiente que provê uma vivência empresarial
          aos estudantes.
        </p>
        {/* Números */}
          ...
          <div>
            <div className="text-center sm:text-left">
              ...
              <p className="text-[10px] sm:text-[12px]">
                Formar estudantes mais profissionais e mais capacitados por meio
            ...
            <div className="my-2 text-center sm:text-left">
              ...
              <p className="text-[10px] sm:text-left sm:text-[12px]">
                ...
                Fortalecer a representatividade da EC no ambiente acadêmico e no
                mercado.
              </p>
            </div>
          </div>
